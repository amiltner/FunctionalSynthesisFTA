...
dfburstcorr=pd.read_csv("code/manual-data/postconditional.csv")
dfleoncorr=pd.read_csv("leon/manual-data/postconditional.csv")
dfsynquidcorr=pd.read_csv("synquid/manual-data/postconditional.csv")
...
result5.to_csv("generated-data/postconditional.csv")

dfex=pd.read_csv("code/generated-data/examples.csv")
