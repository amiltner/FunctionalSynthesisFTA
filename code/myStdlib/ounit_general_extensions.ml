...
let assert_int_list_option_equal =
  assert_equal
    ~printer:(string_of_option (string_of_list string_of_int))
    ~cmp:(Option.compare (List.compare Int.compare))
